...
$base_url = 'http://'.$_SERVER['HTTP_HOST'].'/telkom/'; 
...
<div id="container">
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				<div class="page-header"><h3>Login Telkom <small> Iwan's code</small></h3></div>
				<ul class="nav nav-tabs">
					<li <?php echo $app=='home'?'class="active"':'';?>><a href="index.php"><i class="icon-home"></i> Home</a></li>
					<?php if(isset($_SESSION['level'])){?>
					
					<li <?php echo $app=='ide'?'class="active"':'';?>><a href="index.php?app=ide"><i class="icon-list-alt"></i> Lihat Ide</a></li>
					<?php }?>
...
<p class="footer">Developed By <a href="https://www.facebook.com/BlckZn"><b>Rama </b></a></p>
</div>
</body>
</html>
