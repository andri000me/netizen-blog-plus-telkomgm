...
//                                $alltotal = mysql_fetch_object($hasil);
                           //=====sniff tampil data==================
                                $result = mysql_query("SELECT namadepan,namaakhir,alamatsitus,nilai1,nilai2,nilai3,nilai4,nilai5,(nilai1+nilai2+nilai3+nilai4+nilai5)as total FROM lombacuy ORDER BY total DESC");			
